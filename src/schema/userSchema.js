...
const userSchemaCreate = z.object({
    ...
    carrera: z.enum(['Ingeniería en Información y Control de Gestión', 'Contador Auditor - Contador Público', 'Ingeniería comercial'],{ required_error: "La carrera es requerida" }),
})
